...
class tec_controller(object): 
    # just a class really for testing right now
    # will be moved to a different file when everything is operational
    """
    Controlling multiple TEC devices via serial.
    """
...
if __name__ == "__main__":    
    ...
    this testing code needs to be updated for use with the new class
    print("querying device 1")
    address = addresses[0].identify()
